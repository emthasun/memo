class OwnText {
    ...
    clickAccess() {
        //when clicking on the access-button, we change the opacity of the body to 0 and after 1.5 seconds, we redirect to the menuOwn.html
        const bigContainerBody = document.getElementById("big-container-body");
        const bigContainerBody2 = document.getElementById("big-container-body2");
        const bigContainerBody3 = document.getElementById("big-container-body3");
        const accessButton = document.getElementById("access-button");
        ...
        if (accessButton) {
            accessButton.addEventListener("click", () => {
                ...
                bigContainerBody3.style.opacity = 0;
                setTimeout(() => {
                    window.location.href = "menuOwn.html";
                }, 1500);
            });
        }
    }
    ...
    setInitialButtonColors() {
        const goalButton1 = document.getElementById("goal-button1-FR");
        const goalButton2 = document.getElementById("goal-button2-FR");
        const goalButton3 = document.getElementById("goal-button3-FR");
